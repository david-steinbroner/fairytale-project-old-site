...
<option value="index.php" <?php if($_SERVER['PHP_SELF'] == '/dev/index.php') echo 'selected'; ?>>肖像 / Grid / Raster</option>
<option value="map.php" <?php if($_SERVER['PHP_SELF'] == '/dev/map.php') echo 'selected'; ?>>地图 / Map / Karte</option>
</select>
</form>
</div>
...
<a href="http://clicktotweet.com/WiSEb" target="_blank" class="twitter">Twitter</a>
...
<a href="http://share.renren.com/share/buttonshare.do?link=https://www.fairytaleproject.net&title=The%20Fairytale%20Project" target="_blank" class="renren">RenRen</a>
