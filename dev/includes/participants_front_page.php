<?php
	...
	while ( $participant = mysql_fetch_array($participants_set)) {
		...
		echo '<img class="REG participant_front_page lazy inactive" id="picid-'. $participant["id"] .'" data-original="'.$picid.'" src="images/person.png" alt="'.$participant["id"].'"><noscript><img class="lazy" src="'.$picid.'" alt="'.$participant["id"].'"></noscript>';
		// echo '<img class="BIGHIDDEN participant_front_page inactive" id="picid-'. $participant["id"] .'" data-original="'.$bigpicid.'" src="images/person.png" alt="'.$participant["id"].'">';
