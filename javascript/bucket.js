...
// if ($(".participant_front_page").width() < participants_orig_width){
//	$("#participants").width("101%");
//	$(".participant_front_page").width($(".participant_front_page").width() + 25);
...
// } else if ($(".participant_front_page").width() <= 200){
//	$("#participants").width($("#participants").width() + 325);
//	$(".participant_front_page").width($(".participant_front_page").width() + 25);
//	$(".outer").width($(".outer").width() + 25);
//	var curFontSize = $(".outer p").css("font-size");
//	$(".outer p").css("font-size", parseInt(curFontSize)+1);
else {
return false;
...
$("#participants").width("100%");
//	if ( $("#participants").width > viewportWidth) {
//		$("#participants").width($("#participants").width() - 325);
//		} else {
//		$("#participants").width(viewportWidth + 5);
//	}
